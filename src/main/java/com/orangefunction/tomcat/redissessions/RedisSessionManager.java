...
public class RedisSessionManager extends ManagerBase implements Lifecycle {
    ...
    public Session findSession(String id) throws IOException {
        ...
        if (null == id) {
            ...
            String data = loadSessionDataFromRedis(id);
            if (data != null) {
    ...
    public String loadSessionDataFromRedis(String id) throws IOException {
        Jedis jedis = null;
        Boolean error = true;
    ...
    public DeserializedSessionContainer sessionFromSerializedData(String id, String data) throws IOException {
        ...
        try {
            ...
            if (!Arrays.equals(data.getBytes(), NULL_SESSION)) {
    ...
    private void initializeSerializer() throws ClassNotFoundException, IllegalAccessException, InstantiationException {
        ...
        serializer.setGsonLoader(new Gson());
    }
...
class DeserializedSessionContainer {
    ...
    public DeserializedSessionContainer() {
        this.session = null;
        this.metadata = null;
    }
